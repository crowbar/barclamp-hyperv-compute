### **This barclamp (master) moved to [crowbar-hyperv](https://github.com/crowbar/crowbar-hyperv). This repo only accepts bugfixes for tex and older**.
...
[![Build Status](https://travis-ci.org/crowbar/barclamp-hyperv-compute.svg?branch=release/tex/master)](https://travis-ci.org/crowbar/barclamp-hyperv-compute)
